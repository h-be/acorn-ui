...
export default function IndentedTreeView({ goalTree }) {
  ...
  return <div className="indented-view-wrapper">
    <div className="indented-view-search">
                <Icon name='search.svg' size='very-small' />
                <input type='text' onChange={e => setFilterText(e.target.value)} value={filterText} placeholder='Search a card or subtree' autoFocus />
